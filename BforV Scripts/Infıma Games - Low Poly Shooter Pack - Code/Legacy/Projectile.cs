...
public class Projectile : MonoBehaviour {
	...
	private void OnCollisionEnter (Collision collision)
	{
        ...
        {
			collision.transform.gameObject.GetComponent
				<New_Enemy>().health -= collision.transform.gameObject.GetComponent
				<New_Enemy>().takenDamage;
			collision.transform.gameObject.GetComponent
				<New_Enemy_Chasing>().health -= collision.transform.gameObject.GetComponent
				<New_Enemy_Chasing>().takenDamage;
		}
